...
<div class="right" id="right">
  <div class="title">
  <span>增添名额</span><a href="<?php echo u_('jobnamelist') ?>" style="display:inline-block;background:#08DEC2;">返回</a>
  </div>
...
<td>
<a href="<?php echo u_('addjobnamelist2',array('id'=>$v['id'],'jid'=>$jobid));?>" onClick="return confirm('确定添加？')">添加</a></td>
</tr>
<?php endforeach;?>
</tbody>
</table>
