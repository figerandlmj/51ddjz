...
<div class="right" id="right">
  <div class="title"><span>添加公告</span><a href="<?php echo u_('index') ?>" style="display:inline-block;background:#08DEC2;">返回</a>
  </div>
...
<td><input type="text" name="endtime" class="Wdate" value="<?php echo date("Y-m-d",time()+3600*24*100);?>" readonly onClick="WdatePicker()"><span> * 必须填写，默认公告100天</span></td>
</tr>
