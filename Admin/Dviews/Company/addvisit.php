...
<div class="right" id="right">
  <div class="title"><span>添加记录</span><a href="<?php echo u_('visit') ?>" style="display:inline-block;background:#08DEC2;">返回</a>
  </div>
...
<td><input type="text" name="vistime" class="Wdate" value="<?php echo date("Y-m-d",time());?>" readonly onClick="WdatePicker()"><span>* </span></td>
</tr>
...
<td><textarea name="info" style="width:500px; height:80px;" placeholder="拜访内容"></textarea><span>* </span></td>
</tr>
