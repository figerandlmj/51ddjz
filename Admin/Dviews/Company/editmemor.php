...
<div class="right" id="right">
  <div class="title"><span>编辑<?php echo $info['cname']?> 备忘录</span><a href="<?php echo u_('memor') ?>" style="display:inline-block;background:#08DEC2;">返回</a>
  </div>
...
<td><input type="text" name="warntime" class="Wdate" value="<?php echo date("Y-m-d H:i", $info['warntime']);?>" readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"><span>* </span></td>
</tr>
<tr><td width="100" align="right">备忘内容：</td>
<td><textarea name="info" style="width:500px; height:80px;" placeholder="内容"><?php echo $info['info']?></textarea><span>* </span></td>
</tr>
